...
export async function fetchBookContent() {
    // Project Gutenberg URL for The Great Gatsby (Plain Text)
    // Note: Project Gutenberg might have CORS issues. We'll try, but rely on fallback.
...
has opened up many curious natures to me and also made me the victim of
...
because I was privy to the secret griefs of wild, unknown men. Most of
the confidences were unsought--frequently I have feigned sleep,
...
heart. Only Gatsby, the man who gives his name to this book, was exempt
...
... [More content available in full version] ...
`;
    ...
    try {
        ...
        // Simple parsing to start after the header
        ...
        console.warn('Network book fetch failed, using fallback:', error);
        return fallbackText;
    }
}
